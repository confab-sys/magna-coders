...
export interface Message {
  ...
  senderId: string;
  content: string;
  type: 'TEXT' | 'IMAGE' | 'FILE' | 'VOICE' | 'text' | 'file'; // Updated for compatibility
  fileUrl?: string;
  fileName?: string;
  fileSize?: number;
  isRead: boolean;
  ...
  } | string; // Updated to allow string for compatibility
...
export interface Chat {
  ...
  lastMessage?: Message | string; // Updated to allow string for compatibility
  unreadCount: number;
  createdAt: string;
  updatedAt: string;
  // UI compatibility fields
...
export interface SendMessageData {
  content: string;
  type?: 'TEXT' | 'IMAGE' | 'FILE' | 'VOICE' | 'text' | 'file';
  fileUrl?: string;
  fileName?: string;
  fileSize?: number;
}
