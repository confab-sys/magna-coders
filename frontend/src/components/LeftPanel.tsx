    ...
    return (
      <div className="flex flex-col h-full">
        ...
        <nav className="space-y-1 mb-6 mt-4">
          ...
          <Link href="/magna-podcast" className="block">
            <NavItem 
              icon={<Mic size={20} />} 
              label="Magna Podcast" 
              active={activeTab === 'Magna Podcast'} 
              isMobile={isMobile} 
              isDarkMode={isDarkMode}
              onClick={() => handleNavClick('Magna Podcast')} 
            />
          </Link>
          <Link href="/magna-contract" className="block">
            <NavItem 
              icon={<FileText size={20} />} 
              label="Magna Contract" 
              active={activeTab === 'Magna Contract'} 
              isMobile={isMobile} 
              isDarkMode={isDarkMode}
              onClick={() => handleNavClick('Magna Contract')} 
            />
          </Link>
          <Link href="/magna-software-services" className="block">
            <NavItem 
              icon={<Code2 size={20} />} 
              label="Magna Software Services" 
              active={activeTab === 'Magna Software Services'} 
              isMobile={isMobile} 
              isDarkMode={isDarkMode}
              onClick={() => handleNavClick('Magna Software Services')} 
            />
          </Link>
        </nav>
      ...
      isDarkMode 
        ...
        <div className="p-6 relative">
          ...
          <nav className="space-y-1">
            ...
            <Link href="/magna-contract">
              <div className={`relative w-full flex items-center justify-center ${isSidebarExpanded ? 'lg:justify-between px-2 lg:px-4' : 'lg:justify-center px-0'} py-3 rounded-full transition-all text-sm font-medium cursor-pointer ${activeTab === 'Magna Contract' ? 'bg-[#E50914] text-white shadow-md' : isDarkMode ? 'text-gray-400 hover:text-white hover:bg-white/10' : 'text-gray-600 hover:bg-gray-100'}`} onClick={() => handleNavClick('Magna Contract')}>
                <div className="flex items-center gap-3">
                  <FileText size={20} />
                  <span className={`hidden ${isSidebarExpanded ? 'lg:block' : ''}`}>Magna Contract</span>
                </div>
              </div>
            </Link>
            <Link href="/magna-software-services">
              <div className={`relative w-full flex items-center justify-center ${isSidebarExpanded ? 'lg:justify-between px-2 lg:px-4' : 'lg:justify-center px-0'} py-3 rounded-full transition-all text-sm font-medium cursor-pointer ${activeTab === 'Magna Software Services' ? 'bg-[#E50914] text-white shadow-md' : isDarkMode ? 'text-gray-400 hover:text-white hover:bg-white/10' : 'text-gray-600 hover:bg-gray-100'}`} onClick={() => handleNavClick('Magna Software Services')}>
                <div className="flex items-center gap-3">
                  <Code2 size={20} />
                  <span className={`hidden ${isSidebarExpanded ? 'lg:block' : ''}`}>Magna Software Services</span>
                </div>
              </div>
            </Link>
          </nav>
