...
import { LayoutDashboard, Search, MessageSquare, Bell } from 'lucide-react';
          ...
          >
            <div className="relative">
              ...
              {item.label === 'Notifications' && unreadCount > 0 && (
                 <div className={`absolute -top-1 -right-1 w-4 h-4 bg-[#E50914] rounded-full flex items-center justify-center text-white text-[9px] font-bold border-2 shadow-sm ${isDarkMode ? 'border-black' : 'border-white'}`}>
